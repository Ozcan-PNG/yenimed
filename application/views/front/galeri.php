            ...
            <div class="row three-column">
                <div id="gridWrapper" class="clearfix">
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 portfolio-wrapper III_column" data-groups='["all", "website", "photoshop"]'>
                        <div class="portfolio-thumb">
                            ...
                            <div class="portfolio_icon_wrapper_3 zoom_popup">
                                <a class="img-link" href="<?php echo base_url ('assets/front/') ?><?php echo base_url ('assets/front/') ?>images/dc_galry_img_1.jpg"> <i class="fa fa-search-plus"></i>
                                </a>
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 portfolio-wrapper III_column" data-groups='["all", "business", "website", "photoshop"]'>
                        <div class="portfolio-thumb">
                            <div class="port_img_wrapper">
                                <img src="<?php echo base_url ('assets/front/') ?>images/dc_galry_img_2.jpg" alt="filter_img">
                            </div>
                            <div class="portfolio_icon_wrapper_3 zoom_popup">
                                <a class="img-link" href="<?php echo base_url ('assets/front/') ?>images/dc_galry_img_2.jpg"> <i class="fa fa-search-plus"></i>
                                </a>
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 portfolio-wrapper III_column" data-groups='["all", "website", "business"]'>
                        <div class="portfolio-thumb">
                            <div class="port_img_wrapper">
                                <img src="<?php echo base_url ('assets/front/') ?>images/dc_galry_img_3.jpg" alt="filter_img">
                            </div>
                            <div class="portfolio_icon_wrapper_3 zoom_popup">
                                <a class="img-link" href="<?php echo base_url ('assets/front/') ?>images/dc_galry_img_3.jpg"> <i class="fa fa-search-plus"></i>
                                </a>
                            </div>
