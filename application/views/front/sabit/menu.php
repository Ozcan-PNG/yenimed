    ...
    <ul>
        <li><a href='<?php echo base_url () ?>'>Ana Sayfa</a>
        </li>
        <li><a href="<?php echo base_url ('hakkimizda') ?>">hakımızda</a></li>
       ...
       <li ><a href='<?php echo base_url ('doktorlar') ?>'>doktorlarımız</a>
       </li>
       <li><a href='<?php echo base_url ('galeri') ?>'>Galeri</a>
       </li>
